...
<?php
    ...
    function hasMaterial($id) {
        ...
        foreach ($courseMaterials as $courseMaterial) {
            if ($courseMaterial->Course_ID == $id) {
                $has[] = 'yes';
            }
        }
...
@section('page-content')
    ...
    <nav class="sec-nav">
        <ul>
            <li class="sec-active"><a href="{{ Route('student_library_cm') }}"><h3>Course Materials</h3></a></li>
            <li><a href="{{ Route('student_library_rc') }}"><h3>Recorded Classes</h3></a></li>
        </ul>
    </nav>
        ...
        @foreach ($enrollmentsID as $key => $enrollment)
            <li class="normal-card">
                <div class="card-a" onclick="openModals({{ $key }})">
                    <h3>{{ getCode($enrollment->Course_ID) }}</h3>
            ...
            <div class="modal">
                <div class="modal-box">
                    <svg class="modal-close" onclick="closeModals({{ $key }})" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="modal-content  modal-light-bg">
                        ...
                        @if (!(in_array('yes', hasMaterial($enrollment->Course_ID))))
                            <div class="course-material">
