...
@section('page-content')
    ...
    <form action="{{ Route('add2_essay', ['courseCode' => $courseCode, 'assignID' => $assignID]) }}" method="post" enctype="multipart/form-data" class="assignment-form">
        @csrf

        <div class="form-error" style="position: absolute; top: 295px">
            <p>@error('type') {{ $message }} @enderror</p>
