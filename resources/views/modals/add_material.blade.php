<div class="modal">
    <div class="modal-box">
        ...
        <div class="modal-content modal-content-confirm">
            <form action="{{ route('lecturer_add_material', ['courseCode' => $courseCode]) }}" method="post" enctype="multipart/form-data" class="modal-form">
                @csrf
                <div>
                ...
                <button type="submit" class="normal-btn">Upload</button>
            </form>
        </div>
    </div>
</div>