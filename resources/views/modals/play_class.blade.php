<div class="modal">
    <div class="modal-box">
        <svg class="modal-close" onclick="closeVideoModal()" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="modal-content">
            <video controls>
                <source src="{{ asset('images/jesus.mp4') }}" type="video/mp4">
            </video>
        </div>
    </div>
</div>