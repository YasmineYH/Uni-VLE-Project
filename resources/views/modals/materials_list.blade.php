...
<div class="modal">
    <div class="modal-box">
        <svg class="modal-close" onclick="closeModal()" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="modal-content  modal-light-bg">
            ...
            <!--<li class="normal-card menu">
                <div class="card-a">
                    <h3>{{ substr($courseMaterial->Material_ID, 11) }}</h3>
                </div>
                <div class="floating-menu">
                    <div class="floating-menu-shadow"></div>
                    <ul>
                        <li><a href="{{ Route('download_material', ['materialPath' => $courseMaterial->Material_ID]) }}"><h3>Download</h3></a></li>
                    </ul>
                </div>
            </li>!-->
            @endforeach
            <div class="course-material">
                <p>An algorithm note.doc</p>
            ...
            <div class="course-material">
                <p>Algorithm-Ch6-Heapsort.pdf</p>
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M14 11V14H2V11H0V14C0 15.1 0.9 16 2 16H14C15.1 16 16 15.1 16 14V11H14ZM13 7L11.59 5.59L9 8.17V0H7V8.17L4.41 5.59L3 7L8 12L13 7Z" fill="#002865"/>
                </svg>
            </div>
